...
/**
 * Update PR #6 body with full content
 * Reads PR body from a markdown file to avoid shell escaping issues
 */
...
// Write to file first
const bodyFile = path.join(__dirname, 'pr-body.md');
fs.writeFileSync(bodyFile, prBody, 'utf-8');

console.log('PR body written to:', bodyFile);
console.log('Length:', prBody.length, 'characters');
console.log('Now updating PR...');
