...
- Colors, gradients, shadows, spacing
...
|------|-------|-------------|
| Component.tsx | XXX | Brief description |
| hook.ts | XX | Brief description |
...
| TypeScript compilation | No errors/Errors found |
| Linting | Clean/Issues |
| Console logs | None/Found |
| i18n (VI + EN) | Verified/Not applicable |
| Responsive | Verified/Not applicable |

Closes #<issue_number>
```

**Notes:**
- Keep PR body concise — only Summary and Testing sections required
- Full details go in commit message and documentation files
- Use tables for clean formatting
