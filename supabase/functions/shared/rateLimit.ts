...
export const RATE_LIMITS = {
  ...
  // Chat messages: 60 requests per hour (account); guests use chatGuest in index
  chat: { maxRequests: 60, windowMinutes: 60 } as RateLimitConfig,
  chatGuest: { maxRequests: 24, windowMinutes: 60 } as RateLimitConfig,
  ...
  chatGuestIpCap: { maxRequests: 40, windowMinutes: 60 } as RateLimitConfig,
};
