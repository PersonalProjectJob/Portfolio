...
export const ProjectAgentRules: React.FC = () => {
  ...
  return (
    <CaseStudyLayout>
      ...
      <div className="pt-6 md:pt-10 relative z-10 max-w-5xl mx-auto px-4 md:px-8">
        {/* 01. TỔNG QUAN */}
          ...
          <div className="rounded-3xl overflow-hidden border border-slate-200 dark:border-slate-800 bg-slate-50 dark:bg-slate-900/50 relative">
            ...
            <div className="p-10 md:p-16 relative z-10">
              ...
              <p className={`text-lg max-w-2xl mx-auto mb-10 ${theme.textMuted}`}>
                ...
                <br/><br/>
                Mảnh ghép tiếp theo của bức tranh toàn cảnh nằm ở hệ thống Dispatch Workflow.
              </p>
              <a href="/project/dispatch" className="inline-flex items-center gap-3 px-8 py-4 bg-indigo-600 hover:bg-indigo-700 text-white font-bold rounded-full transition-transform hover:scale-105 shadow-lg shadow-indigo-500/30">
