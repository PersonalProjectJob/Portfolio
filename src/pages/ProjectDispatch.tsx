          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className={`p-8 rounded-2xl border-t-4 border-t-emerald-500 ${theme.card}`}>
              ...
              <ul className="space-y-3 text-sm mb-6">
                <li className="flex flex-col gap-1"><span className="font-bold text-emerald-600 dark:text-emerald-500">Agent</span> <span className={theme.text}>Sonnet / Gemini Flash / Gpt 5.6 Luna (tốc độ cao, chi phí thấp)</span></li>
            ...
            <div className={`p-8 rounded-2xl border-t-4 border-t-amber-500 ${theme.card}`}>
              ...
              <ul className="space-y-3 text-sm mb-6">
                <li className="flex flex-col gap-1"><span className="font-bold text-amber-600 dark:text-amber-500">Agent</span> <span className={theme.text}>Opus / Gemini Pro / Gpt 5.6 Terra (khả năng suy luận sâu)</span></li>
            ...
            <div className={`p-8 rounded-2xl border-t-4 border-t-red-500 bg-slate-900 border border-slate-800`}>
              ...
              <ul className="space-y-3 text-sm mb-6">
                <li className="flex flex-col gap-1"><span className="font-bold text-red-400">Agent</span> <span className="text-slate-200">Opus / Gpt 5.6 Sol (thông minh nhất) + Chốt chặn Con người</span></li>
