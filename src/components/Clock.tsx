...
export const Clock = () => {
  ...
  return (
    <div className={`px-2.5 py-1.5 rounded-md flex items-center justify-center font-mono font-bold text-[11px] tracking-wider transition-colors ${isLightMode ? 'text-slate-800' : 'text-slate-200'}`}>
