             ...
             <div className="flex flex-col gap-6 md:gap-8">
                ...
                <div className={`p-5 md:p-8 rounded-3xl border transition-all duration-500 flex flex-col h-fit ${isLightMode ? 'bg-white/90 backdrop-blur-3xl border-white/80 shadow-[0_8px_32px_rgba(30,41,59,0.12)]' : 'premium-card'}`}>
                   ...
                   <div className="flex flex-col gap-4">
                      <AwardBadge 
                         title="Best Team PXD K17" 
                         subtitle="Outstanding Project Award" 
                         isLightMode={isLightMode} 
                      />
                      <EduItem title="Psychology of UX Design" school="Uxfoundation.vn" date="JUN 2025" isLightMode={isLightMode} />
                      <EduItem title="UX Foundation" school="Uxfoundation.vn" date="OCT 2024" isLightMode={isLightMode} />
                      <EduItem title="Advertising Design" school="cusc.ctu.edu.vn" date="2019 - 2020" isLightMode={isLightMode} />
                   </div>
                </div>
             </div>
             ...
             <div className="flex flex-col gap-6 md:gap-8">
                ...
                <div className={`p-5 md:p-8 rounded-3xl border transition-all duration-500 flex flex-col h-fit lg:min-h-[480px] ${isLightMode ? 'bg-white/90 backdrop-blur-3xl border-white/80 shadow-[0_8px_32px_rgba(30,41,59,0.12)]' : 'premium-card'}`}>
                   <h3 className={`text-lg font-extrabold mb-6 flex items-center gap-3 w-full transition-colors ${isLightMode ? 'text-slate-900' : 'text-slate-100'}`}>
                      ...
                      Passive Skills & Mindset
                   </h3>
                   
                   <div className="flex flex-col gap-4 mt-2 justify-center flex-grow">
                      <HexagonNode 
                         title="Product-Oriented" 
                         desc="Focusing on business value, user needs, and MVP viability over pure aesthetics."
                         isLightMode={isLightMode}
                      />
                      <HexagonNode 
                         title="Cross-Team Collaboration" 
                         desc="Bridging the gap between PMs, Developers, and Stakeholders seamlessly."
                         isLightMode={isLightMode}
                      />
                      <HexagonNode 
                         title="Complex Problem Solving" 
                         desc="Breaking down complicated fintech/AI flows into intuitive user journeys."
                         isLightMode={isLightMode}
                      />
                   </div>
                </div>
...
const RadarChart = ({ isLightMode }: { isLightMode?: boolean }) => {
   const data = [
     { label: 'User Research', value: 0.8 },
     { label: 'UI System Design', value: 0.7 },
     { label: 'Product Strategy', value: 0.7 },
     { label: 'Rapid Prototyping', value: 0.9 },
     { label: 'Usability Testing', value: 0.7 },
     { label: 'AI Integration', value: 0.9 },
   ];
